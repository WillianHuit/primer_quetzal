...
var Iconos = (function () {
  ...
  var TRAZOS = {
    ...
    nube:       '<path d="M7.4 15.4a3.6 3.6 0 0 1 .5-7.2 5 5 0 0 1 9.5 1.2 3.4 3.4 0 0 1-.6 6h-9.4z"/>' +
                '<path d="M8.6 18.2l-1 2.4M12.4 18.2l-1 2.4M16.2 18.2l-1 2.4"/>',
    sol:        '<circle cx="12" cy="12" r="4.4"/>' +
                '<path d="M12 3v2.4M12 18.6V21M3 12h2.4M18.6 12H21"/>' +
                '<path d="m5.6 5.6 1.7 1.7M16.7 16.7l1.7 1.7M18.4 5.6l-1.7 1.7M7.3 16.7l-1.7 1.7"/>',
    foco:       '<path d="M9.4 17.4a5.6 5.6 0 1 1 5.2 0v2.2H9.4z"/>' +
                '<path d="M10.2 21.2h3.6"/><path d="m4 4 16 16"/>',
